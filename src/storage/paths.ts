...
export interface RepositoryPaths { root: string; pipelines: string; index: string; }
...
export function pipelineSpecPath(paths: RepositoryPaths, id: string): string { return join(pipelineDirectory(paths, id), "pipeline.json"); }
